...
# plots (b vs r<R etc.)
# special case for 100 bins R increment
...
for tag in tags:
    ...
    if tag == 'R':
        print "    sss"
        bValCu, bValErrCu, MmagValCu, avgTagValCu = funcFile.calc_bCumm_R(sortedDat, binR, tag)
